const en = {
    ...
    "dash.enter": "Sign In",
    "dash.hello": "Hello",
    "dash.template.bali.title": "Tokyo Adventure",
    "dash.template.bali.desc": "Neon lights, temples, and sushi.",
    "dash.template.safari.title": "Luxury Safari",
    "dash.template.safari.desc": "Wildlife and glamping.",
    "dash.template.rome.title": "Rome Getaway",
    "dash.template.rome.desc": "History, art, and pizzerias.",
    ...
    "dash.optimizedAI": "Your ultimate trip, AI-optimized.",
    "dash.personal": "Personal",
    "dash.group": "Group",
    "dash.createFirstTrip": "Create First Trip",
    "dash.featuredTemplates": "Featured Templates",
    "dash.updatedRecently": "Updated recently",
    "dash.progress": "Progress",
    "dash.openDetails": "Open Details",
    "dash.editInfo": "Edit Info",
    "dash.deleteTrip": "Delete Trip",
    "dash.adminDashboard": "Admin Dashboard",
    "dash.newDestination": "New Destination",
    "dash.whereTo": "Where to?",
    "dash.shortNotes": "Short Notes (Optional)",
    "dash.shortNotesPlaceholder": "Short description of the adventure...",
    ...
    "common.viajante": "Traveler",
    "common.varias": "Various",
    ...
    "ai.placeholder.destination": "Ex: Tokyo, Japan",
    ...
    "trip.editName": "Edit Name",
    "trip.duplicate": "Duplicate Itinerary",
    "trip.delete": "Delete Trip",
    "trip.deleteConfirmation": "Are you sure you want to delete this trip? This action is irreversible.",
